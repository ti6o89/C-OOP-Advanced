...
public class Spy
{
    public string StealFieldInfo(string nameOfInvestigatedClass, params string[] requestedFields)
    {
        Type classType = Type.GetType(nameOfInvestigatedClass);
    ...
    public string CollectGettersAndSetters(string investigatedClass)
    {
        ...
        {
            sb.AppendLine($"{method.Name} will set filed of {method.GetParameters().First().ParameterType}");
        }
